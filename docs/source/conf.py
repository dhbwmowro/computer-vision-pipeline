...
# mowro_computer_vision_pipeline documentation build
...
from mowro_computer_vision_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "mowro_computer_vision_pipeline"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "mowro_computer_vision_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "mowro_computer_vision_pipeline.tex",
        "mowro_computer_vision_pipeline Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
man_pages = [
    (
        master_doc,
        "mowro_computer_vision_pipeline",
        "mowro_computer_vision_pipeline Documentation",
        [author],
        1,
    )
...
texinfo_documents = [
    (
        ...
        author,
        "mowro_computer_vision_pipeline",
        "Project mowro_computer_vision_pipeline codebase.",
        "Data-Science",
    )
]
