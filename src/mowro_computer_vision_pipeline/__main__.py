...
"""Mowro Computer Vision Pipeline file for ensuring the package is executable
as `mowro-computer-vision-pipeline` and `python -m mowro_computer_vision_pipeline`
"""
import importlib
